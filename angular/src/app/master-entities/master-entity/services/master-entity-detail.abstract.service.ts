...
export abstract class AbstractMasterEntityDetailViewService {
  protected readonly fb = inject(FormBuilder);
  protected readonly track = inject(TrackByService);

  public readonly proxyService = inject(MasterEntityService);
  ...
  buildForm() {
    const { name, cost, address } = this.selected || {};

    this.form = this.fb.group({
      name: [name ?? null, []],
      cost: [cost ?? '0', [Validators.required]],
